...
from config import DATA_DIR, SAFE_DIR, ensure_app_dirs, load_env_values


FEEDBACK_COMMANDS = ("/final", "/exclude", "/fix", "/important")
...
def main():
    ...
    print(f"updates_seen={len(updates)} feedback_collected={len(items)} json={json_path}")
    return 0
